...
[![npm version](https://badge.fury.io/js/@flowcircuits%2Ffirestate.svg)](https://www.npmjs.com/package/@flowcircuits/firestate)
...
```bash
pnpm add @flowcircuits/firestate
# or
npm install @flowcircuits/firestate
# or
yarn add @flowcircuits/firestate
```
...
```tsx
// App.tsx
import { FirestateProvider } from '@flowcircuits/firestate'
...
```tsx
// ProjectEditor.tsx
import { useDocument, useCollection, useUndoManager } from '@flowcircuits/firestate'
...
```tsx
import { useIsSynced, useUnsavedChangesBlocker } from '@flowcircuits/firestate'
...
```typescript
import { validate } from '@flowcircuits/firestate'
...
```typescript
import { validateSafe } from '@flowcircuits/firestate'
...
```typescript
import { partialSchema } from '@flowcircuits/firestate'
...
```typescript
import { withId } from '@flowcircuits/firestate'
...
```tsx
import { createStore, FirestateStoreProvider } from '@flowcircuits/firestate'
...
```typescript
import { flattenDiff, unflattenDiff } from '@flowcircuits/firestate'
...
```typescript
import { diffContainsPath, extractDiffValue, createDiffAtPath } from '@flowcircuits/firestate'
...
```typescript
import { isDeepEqual, deepClone, isDiffEmpty, mergeDiffs } from '@flowcircuits/firestate'
...
```typescript
import { createStore, createDocumentSubscription } from '@flowcircuits/firestate'
...
```typescript
import { createUndoManager } from '@flowcircuits/firestate'
...
import * as firestate from '@flowcircuits/firestate'

vi.mock('@flowcircuits/firestate', () => ({
    useDocument: vi.fn(() => ({
...
MIT © [Flow Circuits](https://github.com/flowcircuits)
